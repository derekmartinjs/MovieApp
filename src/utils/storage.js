...
export const stGetUser = () => getJsonObjectFromStorage(stUserKey, { onJsonParseError: stRemoveUser });
...
export const stSaveCurrentMovies = movies => AsyncStorage.setItem(stCurrentMoviesKey, JSON.stringify(movies));
...
export const stSaveRequests = requests => AsyncStorage.setItem(stRequestsKey, JSON.stringify(requests));
...
export const stSaveExploredMovies = movies => AsyncStorage.setItem(getExploredMoviesKey(), JSON.stringify(movies));
